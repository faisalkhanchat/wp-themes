	...
	<div class="container">
		...
		<div class="block_2">
			<!--<?php if(is_active_sidebar('sidebar-2')):?>
             <?php switch_to_blog(7); dynamic_sidebar('sidebar-2'); restore_current_blog(); ?>
            <?php endif;?>-->
                <div class="contact">
                    <p class="row">
                        <span class="col-xs-1">
                        <i class="fa fa-at"></i> </span>
                        <span class="col-xs-11"><a href="mailto:info@aconcaguaexpeditions.com">info@aconcaguaexpeditions.com</a><br><a href="mailto:info@acomara.com">info@acomara.com</a>
                        </span>

                    </p>

                    <p class="row">
                        <span class="col-xs-1"><i class="fa fa-skype"></i> </span>
                        <span class="col-xs-11"> <a href="skype:aconcaguaexpeditions.com?call"> Llámanos ahora por Skype haciendo click aquí </a> </span>					
                    </p>

                    <p class="row">
                        <span class="col-xs-1"><i class="fa fa-mobile"></i> </span>
                         <span class="col-xs-11"><a href="tel:+542614251983">(+54-261) 425-1983</a></span> 
                    </p>
                    <p class="row">
                        <span class="col-xs-1"><i class="fa fa-whatsapp"></i> </span>
                        <span class="col-xs-11"><a href="intent://send/5492616181000#Intent;scheme=smsto;package=com.whatsapp;action=android.intent.action.SENDTO;end">(+54-9-261) 618-1000</a> (fuera de Argentina)
                            <br><a href="intent://send/0261156181000#Intent;scheme=smsto;package=com.whatsapp;action=android.intent.action.SENDTO;end">(0261) 15618-1000</a> (desde Argentina)
                        </span>
                    </p>
                 <!--   <p class="copy">Todos los Derechos Reservados  @ 2001 - 2017</p> -->
                </div>
